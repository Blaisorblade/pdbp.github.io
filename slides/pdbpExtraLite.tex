...
\begin{center}
\begin{itemize}
\item<2-> It is code \emdb{describing} a program
...
\begin{center}
\begin{itemize}
\item<2-> \ttdg{factorial} uses the capabilities \emdb{declared} in type class \ttdg{Program}
\end{itemize}
\end{center}
\end{frame}
...
\begin{center}
\begin{itemize}
\item<2-> \ttdg{factorial} \emdb{implementations} depend on \ttdg{implicit object}'s \emdb{defining} the capabilities of type class \ttdg{Program}
\end{itemize}
\end{center}
\end{frame}
...
\begin{itemize}
\item<12-> to \emdb{transform program implementations}
\end{itemize}
\end{itemize}
\end{itemize}
\end{frame}
