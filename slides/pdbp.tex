...
\begin{frame}[fragile]
\frametitle{\begin{center}\ttdg{FactorialOfIntReadPointfulWritingToConsoleWrittenToConsoleMain}\end{center}}
{\color{DarkGreen}	
\footnotesize{
\begin{verbatim}
object FactorialOfIntReadPointfulWritingToConsoleWrittenToConsoleMain 
    extends Main[`=>ARW`[BigInt, ToConsole]] {
